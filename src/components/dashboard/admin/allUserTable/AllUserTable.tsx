  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        <GoSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" size={18} />
        <input
          type="text"
      ...
      <div className="flex flex-col gap-1 mb-6 pl-2">
        ...
        <p className="text-xs">Monitor, evaluate, and manage system users and member accounts.</p>
      </div>
      ...
      <div className="bg-[#0B0F19] border border-gray-800 rounded-2xl overflow-hidden shadow-2xl">
        {filteredUsers.length === 0 ? (
          <div className="flex h-[40vh] items-center justify-center p-6 text-center">
            <p className="text-sm text-gray-500 font-medium">No members found matching your search.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left">
              ...
              <thead>
                <tr className="border-b border-gray-800">
                  <th className="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">User Image</th>
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider text-center">Delete</th>
                </tr>
              </thead>
              ...
              <tbody className="divide-y divide-gray-800/60">
                {filteredUsers.map((user, index) => (
                  <tr key={user._id || index} className="hover:bg-gray-800/30 transition duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-2">
                        {/* Delete Button */}
                        <button className="p-2.5 rounded-lg bg-gray-800/40 text-gray-400 hover:text-red-400 hover:bg-red-600/10 transition group">
                          <GoTrash size={16} />
                        </button>
                      </div>
                    </td>
