...
const ApplySquadForm = ({
  ...
  // Is applicantId equal to ownerId
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center p-4">
      <motion.div
        ...
        className="max-w-md w-full bg-[#0B0F19] border border-indigo-500/20 rounded-3xl p-8 text-center shadow-2xl"
      >
        
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-indigo-500/10 text-indigo-400 font-bold text-lg">
          👑
        </div>
        ...
        <p className="text-sm text-gray-400">
          ...
          As the owner, you are already a part of this squad and cannot apply to it.
        </p>
        <motion.button
        ...
        >
          <Link href="/dashboard/user/squads">Manage Your Squad</Link>
        </motion.button>
      </motion.div>
    </div>
  );
